    ...
    <div className="user-container">
      <div className="user-search-container">
        ...
        <div className="btn-add-delete">
          ...
          <button className="delete-button3" onClick={handleDeleteAll}>
            Reset Customer Data
          </button>
        </div>
      </div>
      ...
      {isDeleteAllData && (
        <Modal setOpen={setIsDeleteAllData} open={isDeleteAllData}>
          <DeleteAllModal
...
function DeleteAllModal({ handleDelete, closeDeleteAllData }) {
  return (
    <div className="delete-modal">
      ...
      <div className="button-container">
        <button className="cancel-button" onClick={closeDeleteAllData}>
          Cancel
        </button>
